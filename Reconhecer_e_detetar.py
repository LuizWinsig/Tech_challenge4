...
input_video_path = os.path.join(script_dir, 'Video_tc.mp4')  # Substitua 'meu_video.mp4' pelo nome do seu vídeo
output_video_path = os.path.join(script_dir, 'TC4.mp4')  # Nome do vídeo de saída
